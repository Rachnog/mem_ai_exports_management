...
```python export_from_markdown.py --markdown_file ./data/my_export.md --vault_folder exports/my_export```
...
```python export_from_json.py --json_file ./data/my_export.json --vault_folder exports/my_export```
